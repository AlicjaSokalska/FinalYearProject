...
public class SelectOption extends AppCompatActivity {
    ...
    private Button trackPetLocationButton, viewPetLocationButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPetLocationButton = findViewById(R.id.btnViewPetLocation);
        ...
        usersRef.child("pets").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ArrayAdapter<String> adapter = new ArrayAdapter<>(SelectOption.this,
        ...
        trackPetLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SelectOption.this, Tracking.class);
        ...
        viewPetLocationButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String selectedPetName = petSpinner.getSelectedItem().toString();

                Intent intent = new Intent(SelectOption.this, ViewPetLocation.class);
                intent.putExtra("selectedPetName", selectedPetName);
                startActivity(intent);
            }
        });
