...
public class OtherPetWeightData extends AppCompatActivity {
    ...
    private TextView startWeightTextView, endWeightTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_other_pet_weight_data);
            ...
            userPetsReference.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()) {
                        ...
                        long weightTarget;
                        if (selectedPet.getType().equals("Other")) {
                            weightTarget = healthSnapshot.child("petHealthTarget").child("weightGoal").getValue(Long.class);
                        } else {
                        ...
                        displayPetWeightData(currentWeightLong,weightTargetStr);
                        ...
                        // Load weight chart
                        loadWeightChart(weightDataList, Long.parseLong(weightTargetStr), currentWeightLong, entryDates);

                    } else {
                        Toast.makeText(OtherPetWeightData.this, "Pet not found!", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
    ...
    private void displayPetWeightData(Long currentWeightLong,  String weightTarget) {
        // Update the UI
...
// overweight: start weight is above target
    ...
    private void loadWeightChart(ArrayList<Double> weightDataList, double weightTarget, long currentWeight, ArrayList<String> entryDates) {
        ...
        html.append("display: true,");
        html.append("text: 'Target Weight: " + weightTarget + ", Current Weight: " + currentWeight + "'");
        html.append("}");
        html.append("},");
        html.append("scales: {");
        html.append("y: {");
