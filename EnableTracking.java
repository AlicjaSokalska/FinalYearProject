...
public class EnableTracking extends AppCompatActivity {
    public class Tracking extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_enable_tracking);
            ...
            btn_showWaypoint.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    //change to map
                    Intent intent = new Intent(com.example.testsample.EnableTracking.this, ShowSavedLocationList.class);
            ...
            btn_showMap.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (currentLocation != null) {
                        ...
                        Intent intent = new Intent(com.example.testsample.EnableTracking.this, MapsActivity.class);
                        ...
                        Toast.makeText(com.example.testsample.EnableTracking.this, "Location information not available", Toast.LENGTH_SHORT).show();
                    }
                }
            });
                    ...
                    if (snapshot.exists()) {
                        ...
                        if (geofenceLatitude != null && geofenceLongitude != null && geofenceRadius != null) {
                            ...
                            if (distance[0] > geofenceRadius) {
                                ...
                                Toast.makeText(com.example.testsample.EnableTracking.this, "Pet is outside the geofence!", Toast.LENGTH_SHORT).show();
                                sendNotification("Pet is outside the geofence!");
                            } else {

                                Toast.makeText(com.example.testsample.EnableTracking.this, "Pet is inside the geofence!", Toast.LENGTH_SHORT).show();
        ...
        private void updateGPS() {
            fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(com.example.testsample.EnableTracking.this);
            // get perm
        ...
        private void updateUIValues(Location location) {
            ...
            // geo
            Geocoder geocoder = new Geocoder(com.example.testsample.EnableTracking.this);
        ...
        private String getAddressFromLocation(Location location) {
            Geocoder geocoder = new Geocoder(com.example.testsample.EnableTracking.this, Locale.getDefault());
            try {
                List<Address> addresses = geocoder.getFromLocation(location.getLatitude(), location.getLongitude(), 1);
                if (!addresses.isEmpty()) {
